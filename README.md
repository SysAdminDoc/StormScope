...
- **Flood and fire-weather planning context**: NOAA WPC excessive-rainfall/significant-river outlooks, optional keyless NOAA NWPS observed/forecast river gauges, and optional SPC Day 1–8 fire-weather forecasts; the UI explicitly distinguishes forecast category from observed stage, wildfire perimeter, and warning claims
